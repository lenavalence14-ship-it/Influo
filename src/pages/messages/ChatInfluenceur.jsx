...
// permettre à deux influenceurs de se répondre via une note (même règle que
// les autres rôles : on ne peut répondre qu'à un utilisateur du même rôle).
export default function ChatInfluenceur() {
  const { id } = useParams()
