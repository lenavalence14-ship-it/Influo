...
export default function ClientProfileView() {
  ...
  useEffect(() => {
    ...
    const load = async () => {
      const { entreprise: userRow, clientProfile: cliRow, posts: enrichedPosts } = await profileApi.fetchClientProfileViewPage(id)
      if (cancelled) return

      setEntreprise(userRow)
      setClientProfile(cliRow)
