...
async function fetchNotes() {
  const { data } = await supabase
    .from('notes')
    .select('id, user_id, contenu, created_at, expire_at, repost_of, photo_url, filtre, crop, texte_overlay, texte_x, texte_y, texte_couleur, texte_police, users(id, nom_complet, photo_url, role)')
