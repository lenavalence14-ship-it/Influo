...
export default function Feed() {
  ...
  // Le suivi (isFollowing/toggleFollow) est désormais entièrement géré par
  // useFollow (voir hooks/useFollow.js), appelé directement dans PostCard :
  // son cache React Query ['following-ids', user.id] est PARTAGÉ entre toutes
  // les instances du hook dans l'app (feed, profils, post détaillé...), donc
  // plus besoin de le dupliquer ici ni de le faire descendre en props --
  // s'abonner depuis n'importe quel écran met à jour tous les autres
  // immédiatement, sans refetch ni remontage de composant.
