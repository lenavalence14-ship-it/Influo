...
export function generateReceipt({ reference, numeroCommande, montant, commission, montantNet, offreTitle, influenceurNom, clientNom, date }) {
  const doc = new jsPDF()
  ...
  row('N° de commande', numeroCommande || '—')
  ...
  doc.save(`recu-influo-${numeroCommande || reference}.pdf`)
}
