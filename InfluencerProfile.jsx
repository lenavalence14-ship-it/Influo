...
export default function InfluencerProfile() {
  ...
  return (
    <div>
      ...
      {/* onglets, avec compteur intégré directement dans le libellé */}
      ...
      {/* sous-barre grille / vidéo, avec compteur intégré, uniquement dans l'onglet Collaboration vérifiée */}
      {tab === 'publications' && (
